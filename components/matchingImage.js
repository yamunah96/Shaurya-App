...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: "#b8b8b8", // Gray background
    alignItems: "center",
  ...
  card: {
    ...
    justifyContent: "center",
    alignItems: "center",
    backgroundColor: "#182854", // Dark Blue card background
    borderRadius: 8,
    shadowColor: "#000",
  ...
  cardBack: {
    width: "100%",
    height: "100%",
    backgroundColor: "#182854", //  Dark Blue color for the back
    borderRadius: 8,
  },
  flipped: {
    backgroundColor: "#182854", // White background for flipped cards
  },
  cardText: {
    fontSize: 28,
    fontWeight: "bold",
